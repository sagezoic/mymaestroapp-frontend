                ...
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><hr class="dropdown-divider"/></li>
                            <li><Link to="/maestro/dashboard/payments" class="dropdown-item">Payments</Link></li>
                            <li><hr class="dropdown-divider"/></li>
                            <li><Link to="/maestro/dashboard/profile" class="dropdown-item">Profile</Link></li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="#">Software Engineers</a></li>
                            <li><hr class="dropdown-divider"/></li>
                            ...
                            <li><hr class="dropdown-divider"/></li>
                            <li><a class="dropdown-item" href="#">Mental Health Experts</a></li>
                            <li><hr class="dropdown-divider"/></li>
